...
public class BeneficiaryTest
{
    ...
    public void TestCreator(uint id, string name, string cpf, OperatorType operatorType, DateTime birthDate)
    {
        DateTime now = DateTime.Now;
        var beneficiary = new Beneficiary(id, null, operatorType, name, cpf, birthDate, now, null, null);
